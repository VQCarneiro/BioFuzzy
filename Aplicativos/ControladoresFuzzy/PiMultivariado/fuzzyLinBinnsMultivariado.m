...
%% Dados Originais
function [resumo completa pertinencias parametros] = fuzzyLinBinnsMultivariado(dados, pmPid_v1,pmPif_v1,pmPid_v2,pmPif_v2)
...
% figure(1)
if pmPiDesf_Var2 >= 50;
Parametro5 = 2*pmPiDesf_Var2 - 100;
Parametro6 = 100;
else
    Parametro5 = 0;
    Parametro6 = 2*pmPiDesf_Var2 - 0;
end

fis = addvar(fis,'input','Pid-Var-2',[0 100]);
fis = addmf(fis,'input',3,'Baixo','zmf',[Parametro5 Parametro6]);
fis = addmf(fis,'input',3,'Alto','smf',[Parametro5 Parametro6]);
...
if pmPiFav_Var2 >= 50;
Parametro7 = 2*pmPiFav_Var2 - 100;
Parametro8 = 100;
else
    Parametro7 = 0;
    Parametro8 = 2*pmPiFav_Var2 - 0;
end

fis = addvar(fis,'input','Pif-Var-2',[0 100]);
fis = addmf(fis,'input',4,'Baixo','zmf',[Parametro7 Parametro8]);
fis = addmf(fis,'input',4,'Alto','smf',[Parametro7 Parametro8]);
% subplot(2,2,4)
% plotmf(fis,'input',4);
% grid(gca,'minor')

parametros = [Parametro1 Parametro2 Parametro3 Parametro4 Parametro5 Parametro6 Parametro7 Parametro8];
...
cabRegrasMult = {'Genótipos', 'pidVar1' , 'pifVar1','pidVar2', 'pifVar2','A.G.' , 'P.A.','A.A.F.', 'A.A.D'};
