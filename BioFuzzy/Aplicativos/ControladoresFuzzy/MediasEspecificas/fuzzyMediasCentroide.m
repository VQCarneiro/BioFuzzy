...
function [matrizResumo tabelaClassOriginal tabelaClassPadronizado pertinencias parametros] = fuzzyMediasCentroide(dadosOriginais,PM,tipo)
...
for i = 1:nVariaveis
    ...
    a.input(i).mf(2).params = parametros(i,:);
    parametros(i,:)
end
...
% end
cabTabelaClass = {'Genotipos', 'Médias Favoraveis', 'Médias Desfavoraveis', 'A.G.', 'P.A.','A.A.F.','A.A.D.'};
